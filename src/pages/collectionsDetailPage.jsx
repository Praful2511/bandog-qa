...
export const CollectionsDetailPage = (params) => {
  ...
  return (
    <div>
      <div className="bg-white bg-opacity-[0.03]">
        <div className="px-4 lg:px-24 3xl:px-10 pt-8 sm:pt-10 pb-10">
          <div className="flex justify-between">
            <div className="w-[610px]  h-auto">
              <img className="w-full " src={dogCard} alt="" />
            </div>
            {!location.pathname.includes("bank") && (
              <div className="w-[607px]">
                ...
                <div className=" w-[587px] mt-8">
                  <p>
                    Lorem ipsum dolor sit amet consectetur. Quam integer aliquam
                    odio urna leo a imperdiet et. Tristique id nec sed faucibus.
                    Faucibus aenean enim donec neque diam amet sem iaculis.
                    Venenatis ornare fringilla egestas turpis nibh lobortis
                    volutpat.
                  </p>
                </div>
                <div className="mt-7">
                  <div className="text-sm font-normal opacity-[0.7]">
                    Price:
                  </div>
                  ...
                  <div className="flex mt-3 w-full gap-4 justify-between">
                    ...
                    >
                      <div className="flex gap-2">
                        ...
                        <di className="text-white text-base font-normal">
                          Bank Transfer
                        </di>
                      </div>
                    </SecondaryButton>
